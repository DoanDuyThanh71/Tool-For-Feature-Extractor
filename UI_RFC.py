...
class Worker(QtCore.QThread):
    ...
    def run(self):
        shell = False
        appRun(self.path, self.col, self.delta, self.row_selected)
        self.finished.emit()
...
class Ui_Reinforcement(object):
    ...
    def run_app(self):
        ...
        self.worker = Worker(self.path, self.col, self.delta, self.row_selected)
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "Adding Object"))
